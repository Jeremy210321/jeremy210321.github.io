                ...
                <form method="POST" action="{{ route('guard.create') }}" class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="first_name" class="block mt-2 w-full" type="text" name="first_name"
                            :value="old('first_name')" placeholder="Enter the first name" maxlength="35" required />
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="last_name" class="block mt-2 w-full" type="text" name="last_name"
                            :value="old('last_name')" placeholder="Enter the last name" maxlength="35" required />
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="username" class="block mt-2 w-full" type="text" name="username" :value="old('username')"
                            placeholder="Enter the username" maxlength="20" required />
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="personal_phone" class="block mt-2 w-full" type="text" name="personal_phone"
                            maxlength="10" :value="old('personal_phone')" placeholder="Example: 0989999999" required />
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="home_phone" class="block mt-2 w-full" type="text" name="home_phone" maxlength="9"
                            :value="old('home_phone')" placeholder="Example: 022999999" required />
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <x-input id="address" class="block mt-2 w-full" type="text" name="address" :value="old('address')"
                            placeholder="Enter the address" maxlength="50" required />
